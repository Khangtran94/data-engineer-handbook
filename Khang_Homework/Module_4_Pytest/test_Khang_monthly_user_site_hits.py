...
from ..jobs.Khang_monthly_user_site_hits import do_monthly_user_site_hits_transformation
...
def test_monthly_site_hits(spark):
    ...
    expected_values = [
        MonthlySiteHitsAgg(
            month_start=ds,
            num_hits_first_day=5,
            num_hits_second_day=9,
            num_hits_third_day=13
        ),
        MonthlySiteHitsAgg(
            month_start=new_month_start,
